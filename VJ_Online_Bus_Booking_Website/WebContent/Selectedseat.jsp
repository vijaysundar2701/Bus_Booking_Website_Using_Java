...
#Female:disabled + label{
	content: url("images/Femaleseats.png"); 
}
input[type=checkbox]:disabled + label {
	content: url("images/Bookedseats.png"); 
}
</style>
...
<% List list = (List)session.getAttribute("list");
	if(list != null){
		for(int i=0;i<list.size();i++){
			...
			System.out.println("Bookedseat"+map.get("Selectedseat"));
			System.out.println("maleorfemale"+map.get("Gender"));
%>
			var g="<%=map.get("Gender")%>";
			var x=document.getElementById("<%=map.get("Selectedseat")%>");
			if(g=="Female")
			{
				var e = document.getElementById("<%=map.get("Selectedseat")%>"); //Get the element
				e.setAttribute("id", "Female");
				e.disabled=true;
			}
			else
			{
...
<div class="border">
<div class="seat">
<img src="images/availableseat.png" id="img">Available
<img src="images/selectedseats.png" id="img">Selected
<img src="images/Bookedseats.png" id="img">Reserved
<img src="images/Femaleseats.png" id="img">Female
</div>
<div class="left">
<li>
